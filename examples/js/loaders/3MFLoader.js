	...
	parse: function ( data ) {
		...
		function loadDocument( data ) {
			...
			for ( var i = 0; i < modelPartNames.length; i ++ ) {
				...
				var xmlData = new THREE._window.DOMParser().parseFromString( fileText, 'application/xml' );
		...
		function parseRelsXml( relsFileText ) {
			...
			var relsXmlData = new THREE._window.DOMParser().parseFromString( relsFileText, 'application/xml' );
		...
		function buildTexture( texture2dgroup, objects, modelData, textureData ) {
			...
			if ( texture2d ) {
				...
				var blob = new THREE._window.Blob( [ data ], { type: type } );
