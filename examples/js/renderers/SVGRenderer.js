...
THREE.SVGRenderer = function () {
	...
	var _this = this,
		...
		_svg = THREE._window.document.createElementNS( 'http://www.w3.org/2000/svg', 'svg' ),
	...
	function getPathNode( id ) {
		...
		if ( _svgPathPool[ id ] == null ) {
			...
			_svgPathPool[ id ] = THREE._window.document.createElementNS( 'http://www.w3.org/2000/svg', 'path' );
